          ...
          <div className="container contact__container">
            <div className="contact__options">
              <article className='contact__option'>
                ...
                <a href="mailto:Joaquinmelogno24@gmail.com" target='_blank'>Envia un Mensaje</a>
              </article>
              <article className='contact__option'>
                <ImWhatsapp contact__option-icon/>
                <h4>WhatsApp</h4>
                <h4>+598 92 303 511</h4>
                <a href="https://api.whatsapp.com/send?phone=+59892303511" target='_blank'>Envia un Mensaje</a>
              </article>
              <article className='contact__option'>
                <RiMessengerLine contact__option-icon/>
                <h4>Messenger</h4>
                <h4>Joaquin Melogno</h4>
                <a href="https://m.me/joaquin.melogno/" target='_blank'>Envia un Mensaje</a>
              </article>
            </div>
            ...
            <form ref={form} onSubmit={sendEmail}>
              ...
              <button  type='submit' className='btn btn-primary'>Envia un Mensaje</button>
            </form>
          </div>
    </section>
  )
